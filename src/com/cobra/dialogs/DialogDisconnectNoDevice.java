...
public class DialogDisconnectNoDevice extends DialogFragment {
	...
	public static DialogDisconnectNoDevice newInstance(int num,
			String scriptName, int scriptIndex) {
		DialogDisconnectNoDevice f = new DialogDisconnectNoDevice();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = View.inflate(getActivity(),
				R.layout.dialog_disconnect_no_device, null);
...
//				}
		...
		layout_Top.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				DialogDisconnectNoDevice.this.dismiss();
