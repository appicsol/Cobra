...
public class SelectorsContainer extends ViewGroup {

	private int line_height;

	public SelectorsContainer(Context context) {
		super(context);

	}

	public SelectorsContainer(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected LayoutParams generateDefaultLayoutParams() {
		return new LayoutParams(200, 200); // default of 20px spacing
	}
